...
SELECT expressions.id, expressions.a,expressions.b,expressions.operation, expressions.c
FROM (
    SELECT 
    id, a, b, operation, c, case 
...
where expressions.res=expressions.c
order by expressions.id;
